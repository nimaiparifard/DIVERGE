# Tune hyperparameter topk and threshold and run node classification for entropy
# 
# Different from ensemble_edge_predictor_entropy.py:
...
def main():
    parser = argparse.ArgumentParser(
        description='Ensemble edge predictor with entropy uncertainty: tune for all embeddings, aggregate best models'
    )
    ...
    parser.add_argument('--threshold_end', type=float, default=0.7,
    ...
    parser.add_argument('--save_dir', type=str, default='results/ensemble_all_entropy',
    ...
    print('=' * 80)
    print('ENSEMBLE EDGE PREDICTOR WITH ENTROPY UNCERTAINTY (ALL EMBEDDINGS)')
    print('=' * 80)
    ...
    for emb_approach in embedding_approaches:
        ...
        top_k_configs, baseline_result = tune_hyperparameters_entropy(
            gnn_cfg=gnn_cfg,
            embedding=embedding,
        ...
        # Add top k_best configurations (already filtered by tune_hyperparameters_entropy)
    ...
    reporter.report_title("ENSEMBLE EDGE PREDICTOR WITH ENTROPY UNCERTAINTY (ALL EMBEDDINGS)")
